...
const T = {
  ...
  empty_docs:         { en: "No sources yet. Upload a file or add a URL.", nl: "Nog geen bronnen. Upload een bestand of voeg een URL toe.", de: "Noch keine Quellen.", fr: "Aucune source.", es: "Sin fuentes.", pt: "Sem fontes.", hi: "कोई स्रोत नहीं।" },
